              ...
              >
                <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-800/30">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium text-blue-800 dark:text-blue-400">Total Amount:</span>
                    <span className="text-lg font-bold text-blue-800 dark:text-blue-400">${parseFloat(amount).toFixed(2)} USD</span>
                  </div>
                </div>
            ...
            {step === 'processing' && (
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400 text-center">
                  Please wait while we process your payment of ${parseFloat(amount).toFixed(2)}.
                </p>
              </motion.div>
            )}
