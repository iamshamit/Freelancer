...
import { 
  Bell, Check, ChevronRight, X, Filter, Settings, 
                      ...
                      >
                        <div className="flex items-start space-x-3">
                          ...
                          <div className={`flex-shrink-0 h-8 w-8 rounded-full flex items-center justify-center ${
                            `bg-${getNotificationColor(notification.type)}-100 dark:bg-${getNotificationColor(notification.type)}-900/30 text-${getNotificationColor(notification.type)}-600 dark:text-${getNotificationColor(notification.type)}-400`
                          }`}>
                                  ...
                                  >
                                    {categories.find(cat => 
                                      ...
                                      (selectedCategory === 'all' && 
                                        (cat.id === 'application' && ['new_application', 'job_assigned'].includes(notification.type)) ||
                                        (cat.id === 'message' && notification.type === 'new_message') ||
                                        (cat.id === 'payment' && notification.type === 'payment_released') ||
                                        (cat.id === 'milestone' && ['milestone_completed', 'milestone_approval_requested', 'milestone_approved', 'milestones_created'].includes(notification.type)) ||
                                        (cat.id === 'rating' && notification.type === 'new_rating')
                                      )
                                    )?.label || 'General'}
                                  </Badge>
                                </div>
