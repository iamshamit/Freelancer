...
const NotificationCenter = () => {
  ...
  const categories = [
    ...
    { id: "payment", label: "Payments", icon: IndianRupee, count: 0 },
                ...
                {notifications.map((notification) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={`group ${
                        !notification.read
                          ? "ring-2 ring-orange-100 dark:ring-orange-900/30"
                          : ""
                      }`}
                    >
                      <div
                        className={`bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 transition-all hover:shadow-md ${
                          !notification.read
                      ...
                      >
                        <div className="flex items-start space-x-4">
                          ...
                          {/* Notification icon */}
                          <div
                            className={`flex-shrink-0 h-10 w-10 rounded-full flex items-center justify-center ${meta.bgColor}`}
                          >
