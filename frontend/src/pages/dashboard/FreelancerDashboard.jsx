...
const FreelancerDashboard = ({ darkMode, toggleDarkMode }) => {
  ...
  const stats = {
    ...
    successRate:
      profile?.completedJobs > 0
        ? Math.round(
            (profile?.completedJobs / (profile?.completedJobs + 2)) * 100,
          )
        : 0,
  ...
  const recentApplications =
    appliedJobs?.slice(0, 5).map((job) => ({
      ...
      timeAgo: getTimeAgo(
        job.applicants?.find((a) => a.freelancer === user?._id)?.appliedAt ||
          job.createdAt,
      ),
    })) || [];
          ...
          {applicationsLoading ? (
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                ...
                jobs and submit your first application.
              </p>
              <Link
                to="/jobs"
        ...
        >
          ...
          {jobsLoading ? (
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                You don't have any active jobs at the moment. Apply to jobs to
                start working.
              </p>
              <Link
                to="/jobs"
