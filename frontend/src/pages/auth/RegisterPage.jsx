  ...
  const handleSubmit = async (values) => {
    try {
      ...
      if (formData.profilePicture) {
        // If it's a File object, we need to convert it to base64 for the API
        if (formData.profilePicture instanceof File) {
          // The profilePicturePreview is already a base64 string from the FileReader
      ...
      // Note: The navigation is handled in the AuthContext after successful registration
    } catch (err) {
      ...
      <div className="container mx-auto px-4 py-10 z-10">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400">Create your account in a few simple steps</p>
          </motion.div>
          ...
          >
            ...
            <div className="bg-[#131e2f] p-6 border-b border-gray-700/50">
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="text-orange-400 font-medium">Step {step} of 3</div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <span className={`text-sm font-medium ${values.role === 'freelancer' ? 'text-white' : 'text-gray-200'}`}>Freelancer</span>
                      <p className={`text-xs ${values.role === 'freelancer' ? 'text-white' : 'text-gray-400'}`}>I want to find work and get hired</p>
                    </div>
                  </div>
                  {values.role === 'freelancer' && (
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <span className={`text-sm font-medium ${values.role === 'employer' ? 'text-white' : 'text-gray-200'}`}>Employer</span>
                      <p className={`text-xs ${values.role === 'employer' ? 'text-white' : 'text-gray-400'}`}>I want to hire talented freelancers</p>
                    </div>
                  </div>
                  {values.role === 'employer' && (
                    <div className="absolute top-2 right-2">
...
const StepTwo = ({ initialValues, role, onNext, onPrevious, error }) => {
  ...
  const validationSchema = Yup.object({
    skills: role === 'freelancer' 
      ? Yup.array().min(1, 'Please select at least one skill').required('Skills are required')
      : Yup.array(),
          ...
          <Form>
            ...
            <div className="mb-8">
              <label htmlFor="bio" className="block text-gray-300 font-medium mb-2">
                {role === 'freelancer' ? 'Professional Bio' : 'Company Description'}
              </label>
              <div className="mb-3 text-sm text-gray-400">
                {role === 'freelancer' 
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="text-sm text-gray-400 text-center max-w-xs">
                  Upload a professional profile picture. A clear, friendly headshot works best.
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#131e2f] rounded-xl p-6 mb-8 border border-gray-700/50">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center border-b border-gray-700/50 pb-3">
                  ...
                  <span className="font-medium text-white capitalize">{formData.role}</span>
                </div>
                {formData.role === 'freelancer' && formData.skills.length > 0 && (
                  <div>
