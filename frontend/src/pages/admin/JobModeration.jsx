    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        >
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-400">Loading job moderation...</p>
        </motion.div>
      </div>
    );
  }
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="p-3 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:text-orange-500 dark:hover:text-orange-400 shadow-sm hover:shadow-md transition-all duration-200 group"
            >
