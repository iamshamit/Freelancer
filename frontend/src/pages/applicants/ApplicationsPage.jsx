        ...
        >
          ...
          {isLoading ? (
            ...
            <EmptyState
              ...
              description={error.message || "There was an error loading your applications."}
            ...
            <div className="space-y-4">
              ...
              <AnimatePresence>
                {filteredApplications.map((application, index) => {
                  ...
                  const { variant, icon, text } = getStatusInfo(application.applicationStatus);
                    ...
                    >
                      <div className="p-5">
                            ...
                            <div className="flex items-center mt-1 text-gray-500 dark:text-gray-400">
                              {application.employer && (
                                <div className="flex items-center">
                                  ...
                                  <span>{application.employer.name || 'Anonymous Employer'}</span>
                                </div>
                              )}
                              {application.domain && (
                                <>
                                  <span className="mx-2">•</span>
                                  <span>{application.domain.name || 'General'}</span>
                                </>
                              )}
                            </div>
                          </div>
                        ...
                        <div className="flex flex-wrap gap-4 mb-4">
                          {application.budget !== undefined && (
                            <div className="flex items-center text-green-600 dark:text-green-400 font-medium">
                              ...
                              <span>${typeof application.budget === 'number' ? application.budget.toFixed(2) : application.budget}</span>
                            </div>
                          )}
                          ...
                          {appliedAt && (
                            <div className="flex items-center text-gray-500 dark:text-gray-400">
                              ...
                              <span>Applied {formatDistanceToNow(new Date(appliedAt))} ago</span>
                            </div>
                          )}
                        </div>
                        ...
                        <div className="flex flex-wrap justify-between items-center mt-4">
                          ...
                          <Link 
                            to={`/job/${application._id}`}
                            className="ml-auto flex items-center text-gray-600 dark:text-gray-400 hover:text-orange-500 dark:hover:text-orange-400 transition-colors"
                          >
                            View Job Details
